...
public class SVMData {
	...
	public static final double[] biases = { 0, 0, -0.3423244187247540,
			-0.3962027136527820, -0.1245817791529550, -0.2216235591377296,
			-0.2588555386559440, -0.1557001152978647 };
	public static final double[] NORMALIZATION_MINS = { 0, 0, 0, 0, 0, 0 };
	public static final double[] NORMALIZATION_DELTAS = { 255, 127, 255, 127,
			255, 127 };
