...
public class TestResultTime implements Parcelable{
    private int day;
    private int month;
    private int year;
    private int hour;
    ...
    public TestResultTime() {
        // Needed for JSON serialization
    }

    protected TestResultTime(Parcel in) {
        day = in.readInt();
        month = in.readInt();
        year = in.readInt();
        hour = in.readInt();
    ...
    public TestResultTime(int day, int month, int year, int hour, int minute) {
        this.day = day;
        this.month = month;
        this.year = year;
        this.hour = hour;
    ...
    public TestResultTime(String monthDayYearText, String hourMinuteText) {
